...
class TC_VNFC_SCALE_OUT_001_6(TestCase):
    """
    TC_VNFC_SCALE_OUT_001_6 Scale-out VNFC instance with manual scaling event generated by VNF
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_001_6')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_001_6')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_001_6')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_001_6 execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_001_6 execution completed successfully')

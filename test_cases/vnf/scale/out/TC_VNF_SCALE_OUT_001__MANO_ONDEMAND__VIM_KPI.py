...
class TC_VNF_SCALE_OUT_001__MANO_ONDEMAND__VIM_KPI(TestCase):
    """
    TC_VNF_SCALE_OUT_001__MANO_ONDEMAND__VIM_KPI Scale-out VNF instance with on-demand scaling event generated by MANO.
    The stimulus for scaling out is a VIM key performance indicator threshold crossing.
    ...
    6. Trigger a resize of the NS resources by altering a VIM KPI
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_001__MANO_ONDEMAND__VIM_KPI')
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_001__MANO_ONDEMAND__VIM_KPI')

        return True

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_001__MANO_ONDEMAND__VIM_KPI')
        ...
        if self.ns_instance_id is None:
            LOG.error('TC_VNF_SCALE_OUT_001__MANO_ONDEMAND__VIM_KPI execution failed')
        ...
        # 6. Trigger a resize of the NS resources by altering a VIM KPI
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Triggering a resize of the NS resources by altering a VIM KPI')
        ...
        LOG.info('TC_VNF_SCALE_OUT_001__MANO_ONDEMAND__VIM_KPI execution completed successfully')

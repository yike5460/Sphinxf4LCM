...
class TC_VNF_SCALE_OUT_004_5_2(TestCase):
    """
    TC_VNF_SCALE_OUT_004_5_2 Max vResource VNF limit reached before max NSD limit for scale-out with manual scaling 
    event generated by MANO and scaling step set to max_instances

    Sequence:
    1. Ensure NFVI has vResources so that the NS can be scaled out only scale_out_steps times
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_004_5_2')
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_004_5_2')

        return True

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_004_5_2')

        # --------------------------------------------------------------------------------------------------------------
        # 1. Ensure NFVI has vResources so that the NS can be scaled out only scale_out_steps times
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Ensure NFVI has vResources so that the NS can be scaled out only scale_out_steps times')
        ...
        if reservation_id is None:
            LOG.error('TC_VNF_SCALE_OUT_004_5_2 execution failed')
        ...
        LOG.info('TC_VNF_SCALE_OUT_004_5_2 execution completed successfully')

...
class TC_VNFC_SCALE_OUT_004__MANO_MANUAL__STEP_1(TestCase):
    """
    TC_VNFC_SCALE_OUT_004__MANO_MANUAL__STEP_1 Max vResource VNFC limit reached before max VNFD limit for scale-out with
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_004__MANO_MANUAL__STEP_1')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_004__MANO_MANUAL__STEP_1')
    ...
    def run(self):
        ...
        LOG.info('TC_VNFC_SCALE_OUT_004__MANO_MANUAL__STEP_1 execution completed successfully')

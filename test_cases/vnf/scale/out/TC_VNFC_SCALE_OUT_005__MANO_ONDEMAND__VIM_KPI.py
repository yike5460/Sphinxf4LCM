...
class TC_VNFC_SCALE_OUT_005__MANO_ONDEMAND__VIM_KPI(TestCase):
    """
    TC_VNFC_SCALE_OUT_005_MANO-ONDEMAND_VNF-IND Removal of virtualized specialized hardware acceleration for VNFC
    ...
    def setup(self):
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_005__MANO_ONDEMAND__VIM_KPI')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_005__MANO_ONDEMAND__VIM_KPI')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_005__MANO_ONDEMAND__VIM_KPI execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_005__MANO_ONDEMAND__VIM_KPI execution completed successfully')

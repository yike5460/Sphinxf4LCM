...
class TC_VNFC_SCALE_OUT_004__EM_MANUAL__STEP_MAX(TestCase):
    """
    TC_VNFC_SCALE_OUT_004__EM_MANUAL__STEP_MAX Max vResource VNFC limit reached before max VNFD limit for scale-out with
    manual scaling event generated by EM and scaling step set to max_instances
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_004__EM_MANUAL__STEP_MAX')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_004__EM_MANUAL__STEP_MAX')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_004__EM_MANUAL__STEP_MAX')
        ...
        if reservation_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_004__EM_MANUAL__STEP_MAX execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_004__EM_MANUAL__STEP_MAX execution completed successfully')

...
class TC_VNF_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_1(TestCase):
    """
    TC_VNF_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_1 Max vResource VNF limit reached before max NSD limit for
    scale-out with manual scaling event generated by MANO and scaling step set to 1. The stimulus for scaling out is a
    VIM key performance indicator threshold crossing.
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_1')
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_1')

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_1')
        ...
        for scale_out_step in range(self.tc_input['desired_scale_out_steps'] + 1):
            ...
            if notification_info is None:
                ...
                LOG.debug('Could not validate that NS scale out started')
                self.tc_result['overall_status'] = constants.TEST_FAILED
                self.tc_result['error_info'] = 'Could not validate that NS scale out started'
                return False
            notification_info = self.mano.search_in_notification_queue(notification_queue=notification_queue,
                                                                       notification_type=VnfLifecycleChangeNotification,
            ...
            if notification_info is None:
                LOG.error('TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__EM_IND__STEP_1 execution failed')
                LOG.debug('Could not validate that NS scale out finished')
                self.tc_result['overall_status'] = constants.TEST_FAILED
                self.tc_result['error_info'] = 'Could not validate that NS scale out finished'
                return False
        ...
        LOG.info('TC_VNF_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_1 execution completed successfully')

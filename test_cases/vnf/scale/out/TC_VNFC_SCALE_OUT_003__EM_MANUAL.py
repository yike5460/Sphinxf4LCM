...
class TC_VNFC_SCALE_OUT_003__EM_MANUAL(TestCase):
    """
    TC_VNFC_SCALE_OUT_003__EM_MANUAL Scale-in VNFC instance with manual scaling event generated by EM
    ...
    5. Trigger a resize of the VNF resources to the next level by instructing the EM to instruct the MANO to scale out
       the VNF
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_003__EM_MANUAL')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_003__EM_MANUAL')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_003__EM_MANUAL')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_003__EM_MANUAL execution failed')
        ...
        # --------------------------------------------------------------------------------------------------------------
        # 5. Trigger a resize of the VNF resources to the next level by instructing the EM to instruct the MANO to scale
        #    out the VNF
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Triggering a resize of the VNF resources to the next level by instructing the EM to instruct the MANO'
        ...
        if len(vnf_info.instantiated_vnf_info.vnfc_resource_info) != \
            ...
            LOG.error('TC_VNFC_SCALE_OUT_003__EM_MANUAL execution failed')
            LOG.debug('VNF did not scale to the next level')
            self.tc_result['overall_status'] = constants.TEST_FAILED
            self.tc_result['error_info'] = 'VNF did not scale to the next level'
            return False
        ...
        # 10. Trigger the downsize of the VNF by instructing the EM to instruct the MANO to scale in the VNF
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Triggering the downsize of the VNF by instructing the EM to instruct the MANO to scale in the VNF')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_003__EM_MANUAL execution completed successfully')

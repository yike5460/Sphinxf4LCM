...
class TC_VNF_SCALE_OUT_001_1(TestCase):
    """
    TC_VNF_SCALE_OUT_001_1 Scale-out VNF instance with manual scaling event generated by MANO
    ...
    def run(self):
        ...
        # - the time it takes the VNF CPU load to build up (caused by the max traffic load)

...
class TC_VNF_SCALE_OUT_001_1(TestCase):
    """
    TC_VNF_SCALE_OUT_001_1 Scale-out VNF instance with on-demand scaling event generated by MANO
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_001_1')
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_001_1')

        return True

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_001_1')
        ...
        if self.ns_instance_id is None:
            LOG.error('TC_VNF_SCALE_OUT_001_1 execution failed')
        ...
        LOG.info('TC_VNF_SCALE_OUT_001_1 execution completed successfully')

...
class TC_VNF_SCALE_OUT_005_5(TestCase):
    """
    TC_VNF_SCALE_OUT_005_5 Removal of virtualized specialized hardware acceleration for VNF scale-in with manual 
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_005_5')
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_005_5')

        return True

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_005_5')
        ...
        if self.ns_instance_id is None:
            LOG.error('TC_VNF_SCALE_OUT_005_5 execution failed')
        ...
        #    the NS
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Trigger a resize of the NS resources to use more specialized hardware by instructing the MANO to '
                 'scale out the NS')
        ...
        # the NS
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Trigger a resize of the NS resources to use less specialized hardware by instructing the MANO to '
                 'scale in the NS')
        ...
        if self.mano.ns_scale_sync(self.ns_instance_id, scale_type='scale_ns', scale_ns_data=scale_ns_data) \
                != constants.OPERATION_SUCCESS:
            LOG.error('TC_VNF_SCALE_OUT_005_5 execution failed')
            LOG.debug('MANO could not scale in the NS')
            self.tc_result['overall_status'] = constants.TEST_FAILED
            self.tc_result['error_info'] = 'MANO could not scale in the NS'
            self.tc_result['scaling_out']['status'] = 'Fail'
            return False
        ...
        LOG.info('TC_VNF_SCALE_OUT_005_5 execution completed successfully')

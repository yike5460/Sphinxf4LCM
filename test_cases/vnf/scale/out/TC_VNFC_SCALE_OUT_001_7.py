...
class TC_VNFC_SCALE_OUT_001_7(TestCase):
    """
    TC_VNFC_SCALE_OUT_001_7 Scale-out VNFC instance with manual scaling event generated by EM
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_001_7')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_001_7')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_001_7')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_001_7 execution failed')
        ...
        # --------------------------------------------------------------------------------------------------------------
        LOG.info(
            'Triggering a resize of the VNF resources by instructing the EM to instruct the MANO to scale out the VNF')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_001_7 execution completed successfully')

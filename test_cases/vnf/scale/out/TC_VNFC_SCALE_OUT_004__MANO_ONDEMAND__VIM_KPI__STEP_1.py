...
class TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_1(TestCase):
    """
    TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_1 Max vResource VNFC limit reached before max VNFD limit for
    scale-out with on-demand scaling event generated by MANO and triggered by a VIM key performance indicator.
    ...
    7. Trigger a resize of the VNF resources to the maximum by altering a VIM KPI
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_1')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_1')

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_1')
        ...
        # 2. check that MANO has subscribed to the VIM
        ...
        for scale_out_level in range(self.tc_input['desired_scale_out_steps'] + 1):
            ...
            if notification_info is None:
                LOG.error('TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_1 execution failed')
                LOG.debug('Could not validate that VNF scale out finished')
            ...
            if notification_info is None:
                ...
                LOG.debug('Could not validate that VNF scale out finished')
                self.tc_result['overall_status'] = constants.TEST_FAILED
                self.tc_result['error_info'] = 'Could not validate that VNF scale out finished'
                return False
        ...
        LOG.info('TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_1 execution completed successfully')

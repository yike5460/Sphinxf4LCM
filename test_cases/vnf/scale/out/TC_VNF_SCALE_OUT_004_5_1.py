...
class TC_VNF_SCALE_OUT_004_5_1(TestCase):
    """
    TC_VNF_SCALE_OUT_004_5_1 Max vResource VNF limit reached before max NSD limit for scale-out with manual scaling 
    event generated by MANO and scaling step set to 1
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_004_5_1')
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_004_5_1')

        return True

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_004_5_1')
        ...
        if reservation_id is None:
            LOG.error('TC_VNF_SCALE_OUT_004_5_1 execution failed')
        ...
        LOG.info('TC_VNF_SCALE_OUT_004_5_1 execution completed successfully')

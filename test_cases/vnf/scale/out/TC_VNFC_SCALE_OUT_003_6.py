...
class TC_VNFC_SCALE_OUT_003_6(TestCase):
    """
    TC_VNFC_SCALE_OUT_003_6 Scale-in VNF instance with manual scaling event generated by VNF
    ...
    5. Trigger a resize of the VNF resources to the maximum by instructing the VNF to instruct the MANO to scale out the 
       VNF
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_003_6')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_003_6')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_003_6')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_003_6 execution failed')
        ...
        # --------------------------------------------------------------------------------------------------------------
        # 5. Trigger a resize of the VNF resources to the maximum by instructing the VNF to instruct the MANO to scale
        #    out the VNF
        # --------------------------------------------------------------------------------------------------------------
        ...
        LOG.info('TC_VNFC_SCALE_OUT_003_6 execution completed successfully')

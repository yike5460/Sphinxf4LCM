...
class TC_VNFC_SCALE_OUT_002__MANO_ONDEMAND__EM_IND(TestCase):
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_002__MANO_ONDEMAND__EM_IND')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_002__MANO_ONDEMAND__EM_IND')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_002__MANO_ONDEMAND__EM_IND')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_002__MANO_ONDEMAND__EM_IND execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_002__MANO_ONDEMAND__EM_IND execution completed successfully')

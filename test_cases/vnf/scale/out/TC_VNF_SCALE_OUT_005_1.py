...
class TC_VNF_SCALE_OUT_005_1(TestCase):
    """
    TC_VNF_SCALE_OUT_005_1 Removal of virtualized specialized hardware acceleration for VNF scale-in with on-demand 
    scaling event generated by MANO
    ...
    6. Trigger a resize of the NS resources to use more specialized hardware by increasing the traffic load to the 
       maximum
    ...
    10. Trigger a resize of the NS resources to use less specialized hardware by increasing the traffic load to the 
        minimum
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_005_1')
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_005_1')

        return True

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_005_1')
        ...
        if self.ns_instance_id is None:
            LOG.error('TC_VNF_SCALE_OUT_005_1 execution failed')
        ...
        #    maximum
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Trigger a resize of the NS resources to use more specialized hardware by increasing the traffic load '
                 'to the maximum')
        ...
        # --------------------------------------------------------------------------------------------------------------
        # 10. Trigger a resize of the NS resources to use less specialized hardware by increasing the traffic load to
        #     the minimum
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Trigger a resize of the NS resources to use less specialized hardware by increasing the traffic load '
                 'to the minimum')
        ...
        LOG.info('TC_VNF_SCALE_OUT_005_1 execution completed successfully')

...
class TC_VNFC_SCALE_OUT_003_5(TestCase):
    """
    TC_VNFC_SCALE_OUT_003_5 Scale-in VNFC instance with manual scaling event generated by MANO
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_003_5')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_003_5')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_003_5')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_003_5 execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_003_5 execution completed successfully')

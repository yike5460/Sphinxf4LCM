...
class TC_VNFC_SCALE_OUT_001__MANO_ONDEMAND__VNF_IND(TestCase):
    """
    TC_VNFC_SCALE_OUT_001__MANO_ONDEMAND__VNF_IND Scale-out VNFC instance with on-demand scaling event generated by
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_001__MANO_ONDEMAND__VNF_IND')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_001__MANO_ONDEMAND__VNF_IND')

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_001__MANO_ONDEMAND__VNF_IND')
        ...
        while elapsed_time < constants.SCALE_INTERVAL:
            ...
            if elapsed_time == constants.SCALE_INTERVAL:
                LOG.error('TC_VNFC_SCALE_OUT_001__MANO_ONDEMAND__VNF_IND execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_001__MANO_ONDEMAND__VNF_IND execution completed successfully')

...
class TC_VNF_SCALE_OUT_001__MANO_ONDEMAND__EM_IND(TestCase):
    """
    TC_VNF_SCALE_OUT_001__MANO_ONDEMAND__EM_IND Scale-out VNF instance with on-demand scaling event generated by MANO.
    ...
    6. Trigger a resize of the NS resources by altering a VNF indicator that is produced by the EM
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_001__MANO_ONDEMAND__EM_IND')
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_001__MANO_ONDEMAND__EM_IND')

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_001__MANO_ONDEMAND__EM_IND')
        ...
        # 6. Trigger a resize of the NS resources by altering a VNF indicator that is produced by the EM
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Triggering a resize of the NS resources by altering a VNF indicator that is produced by the EM')
        ...
        while elapsed_time < constants.SCALE_INTERVAL:
            ...
            if elapsed_time == constants.SCALE_INTERVAL:
                LOG.error('TC_VNF_SCALE_OUT_001__MANO_ONDEMAND__EM_IND execution failed')
        ...
        LOG.info('TC_VNF_SCALE_OUT_001__MANO_ONDEMAND__EM_IND execution completed successfully')

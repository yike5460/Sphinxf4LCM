...
class TC_VNF_SCALE_OUT_001__MANO_ONDEMAND(TestCase):
    """
    TC_VNF_SCALE_OUT_001__MANO_ONDEMAND Scale-out VNF instance with on-demand scaling event generated by MANO
    ...
    6. Trigger a resize of the NS resources by increasing the traffic load to the maximum
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_001__MANO_ONDEMAND')
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_001__MANO_ONDEMAND')

        return True

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_001__MANO_ONDEMAND')
        ...
        if self.ns_instance_id is None:
            LOG.error('TC_VNF_SCALE_OUT_001__MANO_ONDEMAND execution failed')
        ...
        # 6. Trigger a resize of the NS resources by increasing the traffic load to the maximum
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Triggering a resize of the NS resources by increasing the traffic load to the maximum')
        ...
        LOG.info('TC_VNF_SCALE_OUT_001__MANO_ONDEMAND execution completed successfully')

...
class TC_VNF_SCALE_OUT_003__MANO_MANUAL__EM_IND(TestCase):
    """
    TC_VNF_SCALE_OUT_003__MANO_MANUAL__EM_IND Scale-in VNF instance with on-demand scaling event generated by MANO
    ...
    6. Trigger a resize of the NS resources to the next level by increasing the traffic load to the maximum
    ...
    10. Trigger the downsize of the NS by decreasing the traffic load to the minimum
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_003__MANO_MANUAL__EM_IND')
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_003__MANO_MANUAL__EM_IND')

        return True

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_003__MANO_MANUAL__EM_IND')
        ...
        if self.ns_instance_id is None:
            LOG.error('TC_VNF_SCALE_OUT_003__MANO_MANUAL__EM_IND execution failed')
        ...
        # 6. Trigger a resize of the NS resources to the next level by increasing the traffic load to the maximum
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Triggering a resize of the NS resources to the next level by increasing the traffic load to the '
                 'maximum')
        ...
        # --------------------------------------------------------------------------------------------------------------
        # 10. Trigger the downsize of the VNF by decreasing the traffic load to the minimum
        # --------------------------------------------------------------------------------------------------------------
        ...
        LOG.info('TC_VNF_SCALE_OUT_003__MANO_MANUAL__EM_IND execution completed successfully')

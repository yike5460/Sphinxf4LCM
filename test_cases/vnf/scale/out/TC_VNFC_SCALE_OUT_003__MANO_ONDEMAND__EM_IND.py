...
class TC_VNFC_SCALE_OUT_003__MANO_ONDEMAND__EM_IND(TestCase):
    """
    TC_VNFC_SCALE_OUT_003__MANO_ONDEMAND__EM_IND Scale-in VNFC instance with on-demand scaling event generated by MANO. 
    ...
    5. Trigger a resize of the VNF resources to the next level by altering the VNF indicators produced by the EM.
    ...
    9. Trigger the downsize of the VNF by altering the VNF indicators produced by the EM
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_003__MANO_ONDEMAND__EM_IND')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_003__MANO_ONDEMAND__EM_IND')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_003__MANO_ONDEMAND__EM_IND')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_003__MANO_ONDEMAND__EM_IND execution failed')
        ...
        if not self.mano.validate_allocated_vresources(self.tc_input['vnfd_id'], self.vnf_instance_id):
            LOG.error('TC_VNFC_SCALE_OUT_003_MANOO-NDEMAND_EM_IND execution failed')
        ...
        while elapsed_time < constants.SCALE_INTERVAL:
            ...
            if elapsed_time == constants.SCALE_INTERVAL:
                LOG.error('TC_VNFC_SCALE_OUT_003__MANO_ONDEMAND__EM_IND execution failed')
                LOG.debug('VNF has not resized to the next level')
                self.tc_result['overall_status'] = constants.TEST_FAILED
                self.tc_result['error_info'] = 'VNF has not resized to the next level'
        ...
        # - by subscribing for notifications related to VNF Indicator value changes with the EM.
        #   The two operations involved are Subscribe and Notify
        # Insert here code alters the VNF related indicators so that MANO can trigger scale in.
        ...
        LOG.info('TC_VNFC_SCALE_OUT_003__MANO_ONDEMAND__EM_IND execution completed successfully')

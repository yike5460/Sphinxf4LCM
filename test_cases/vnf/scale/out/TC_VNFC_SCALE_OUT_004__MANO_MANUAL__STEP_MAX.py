...
class TC_VNFC_SCALE_OUT_004__MANO_MANUAL__STEP_MAX(TestCase):
    ...
    def setup(self):
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_004__MANO_MANUAL__STEP_MAX')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_004__MANO_MANUAL__STEP_MAX')
        ...
        if reservation_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_004__MANO_MANUAL__STEP_MAX execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_004__MANO_MANUAL__STEP_MAX execution completed successfully')

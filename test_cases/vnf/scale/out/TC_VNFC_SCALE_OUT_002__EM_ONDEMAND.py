...
class TC_VNFC_SCALE_OUT_002__EM_ONDEMAND(TestCase):
    """
    TC_VNFC_SCALE_OUT_002__EM_ONDEMAND Max scale-out VNFC instance with on-demand scaling event generated by EM
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_002__EM_ONDEMAND')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_002__EM_ONDEMAND')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_002__EM_ONDEMAND')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_002__EM_ONDEMAND execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_002__EM_ONDEMAND execution completed successfully')

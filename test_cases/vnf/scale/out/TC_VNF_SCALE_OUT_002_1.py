...
class TC_VNF_SCALE_OUT_002_1(TestCase):
    """
    TC_VNF_SCALE_OUT_002_1 Max scale-out VNF instance with on-demand scaling event generated by MANO
    ...
    6. Trigger a resize of the NS resources to the maximum by increasing the traffic load to the maximum
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_002_1')
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_002_1')

        return True

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_002_1')
        ...
        if self.ns_instance_id is None:
            LOG.error('TC_VNF_SCALE_OUT_002_1 execution failed')
        ...
        # 6. Trigger a resize of the NS resources to the maximum by increasing the traffic load to the maximum
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Triggering a resize of the NS resources to the maximum by increasing the traffic load to the maximum')
        ...
        LOG.info('TC_VNF_SCALE_OUT_002_1 execution completed successfully')

...
class TC_VNFC_SCALE_OUT_005_5(TestCase):
    """
    TC_VNFC_SCALE_OUT_005_5 Removal of virtualized specialized hardware acceleration for VNFC scale-in with manual 
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_005_5')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_005_5')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_005_5')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_005_5 execution failed')
        ...
        if self.mano.vnf_scale_sync(self.vnf_instance_id, scale_type='in', aspect_id=self.tc_input['scaling']['aspect'],
            ...
            self.tc_result['overall_status'] = constants.TEST_FAILED
            self.tc_result['error_info'] = 'MANO could not scale in the VNF'
        ...
        LOG.info('TC_VNFC_SCALE_OUT_005_5 execution completed successfully')

...
class TC_VNFC_SCALE_OUT_005_7(TestCase):
    """
    TC_VNFC_SCALE_OUT_005_7 Removal of virtualized specialized hardware acceleration for VNFC scale-in with manual 
    scaling event generated by EM
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_005_7')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_005_7')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_005_7')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_005_7 execution completed successfully')

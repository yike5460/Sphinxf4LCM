...
class TC_VNFC_SCALE_OUT_001__VNF_ONDEMAND(TestCase):
    """
    TC_VNFC_SCALE_OUT_001__VNF_ONDEMAND Scale-out VNFC instance with on-demand scaling event generated by VNF
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_001__VNF_ONDEMAND')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_001__VNF_ONDEMAND')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_001__VNF_ONDEMAND')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_001__VNF_ONDEMAND execution failed')
        ...
        # 5. Trigger a resize of the VNF resources by increasing the traffic load to the maximum
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Triggering a resize of the VNF resources by increasing the traffic load to the maximum')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_001__VNF_ONDEMAND execution completed successfully')

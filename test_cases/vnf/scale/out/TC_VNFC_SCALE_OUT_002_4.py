...
class TC_VNFC_SCALE_OUT_002_4(TestCase):
    """
    TC_VNFC_SCALE_OUT_002_4 Max scale-out VNFC instance with on-demand scaling event generated by EM
    ...
    def run(self):
        ...
        # 5. Trigger a resize of the VNF resources to the maximum by increasing the traffic load to the maximum
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Triggering a resize of the VNF resources to the maximum by increasing the traffic load to the maximum')

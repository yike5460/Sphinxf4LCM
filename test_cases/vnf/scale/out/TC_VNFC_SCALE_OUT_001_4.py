...
class TC_VNFC_SCALE_OUT_001_4(TestCase):
    """
    TC_VNFC_SCALE_OUT_001_4 Scale-out VNFC instance with on-demand scaling event generated by EM
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_001_4')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_001_4')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_001_4')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_001_4 execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_001_4 execution completed successfully')

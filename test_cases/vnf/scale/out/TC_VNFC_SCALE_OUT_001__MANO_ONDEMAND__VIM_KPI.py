...
class TC_VNFC_SCALE_OUT_001__MANO_ONDEMAND__VIM_KPI(TestCase):
    """
    TC_VNFC_SCALE_OUT_001__MANO_ONDEMAND__VIM_KPI Scale-out VNFC instance with on-demand scaling event generated by MANO. 
    ...
    5. Trigger a resize of the VNF resources by altering the VIM KPI
    ...
    def setup(self):
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_001__MANO_ONDEMAND__VIM_KPI')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_001__MANO_ONDEMAND__VIM_KPI')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_001__MANO_ONDEMAND__VIM_KPI execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_001__MANO_ONDEMAND__VIM_KPI execution completed successfully')

...
class TC_VNFC_SCALE_OUT_002__MANO_ONDEMAND__VNF_IND(TestCase):
    """
    TC_VNFC_SCALE_OUT_002__MANO_ONDEMAND__VNF_IND Max scale-out VNFC instance with on-demand scaling event generated by 
    ...
    5. Trigger a resize of the VNF resources to the maximum by altering the VNF indicators produced by the VNF
    ...
    def setup(self):
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_002__MANO_ONDEMAND__VNF_IND')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_002__MANO_ONDEMAND__VNF_IND')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_002__MANO_ONDEMAND__VNF_IND execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_002__MANO_ONDEMAND__VNF_IND execution completed successfully')

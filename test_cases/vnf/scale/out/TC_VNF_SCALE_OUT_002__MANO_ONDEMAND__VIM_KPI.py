...
class TC_VNF_SCALE_OUT_002__MANO_ONDEMAND__VIM_KPI(TestCase):
    ...
    def setup(self):
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_002__MANO_ONDEMAND__VIM_KPI')

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_002__MANO_ONDEMAND__VIM_KPI')
        ...
        while elapsed_time < constants.SCALE_INTERVAL:
            ...
            if elapsed_time == constants.SCALE_INTERVAL:
                LOG.error('TC_VNF_SCALE_OUT_002__MANO_ONDEMAND__VIM_KPI execution failed')
        ...
        LOG.info('TC_VNF_SCALE_OUT_002__MANO_ONDEMAND__VIM_KPI execution completed successfully')

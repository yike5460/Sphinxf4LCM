...
class TC_VNF_SCALE_OUT_005__MANO_ONDEMAND__VIM_KPI(TestCase):
    """
    TC_VNF_SCALE_OUT_005__MANO_ONDEMAND__VIM_KPI Removal of virtualized specialized hardware acceleration for VNF
    scale-in with on-demand scaling event generated by MANO. The stimulus for scaling in is a VIM key performance
    ...
    6. Trigger a resize of the NS resources to use more specialized hardware by altering a VIM KPI
    ...
    10. Trigger a resize of the NS resources to use less specialized hardware by altering a VIM KPI
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_005__MANO_ONDEMAND__VIM_KPI')
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_005__MANO_ONDEMAND__VIM_KPI')

        return True

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_005__MANO_ONDEMAND__VIM_KPI')
        ...
        if self.ns_instance_id is None:
            LOG.error('TC_VNF_SCALE_OUT_005__MANO_ONDEMAND__VIM_KPI execution failed')
        ...
        # 6. Trigger a resize of the NS resources to use more specialized hardware by altering a VIM KPI
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Triggering a resize of the NS resources to use more specialized hardware by altering a VIM KPI')
        ...
        for vnf_instance_id in ns_info.vnf_info_id:
            if not self.mano.validate_allocated_vresources(self.tc_input['vnfd_id'], vnf_instance_id):
                LOG.error('TC_VNF_SCALE_OUT_005__MANO_ONDEMAND__VIM_KPI execution failed')
                LOG.debug('Could not validate allocated vResources')
                self.tc_result['overall_status'] = constants.TEST_FAILED
                self.tc_result['error_info'] = 'Could not validate allocated vResources for VNF with ID %s' % \
                                               vnf_instance_id
                return False
        ...
        # 10. Trigger a resize of the NS resources to use less specialized hardware by altering a VIM KPI
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Triggering a resize of the NS resources to use less specialized hardware by altering a VIM KPI')
        ...
        # Insert here code that alters a VIM KPI so that MANO can trigger an NS scale in.
        ...
        LOG.info('TC_VNF_SCALE_OUT_005__MANO_ONDEMAND__VIM_KPI execution completed successfully')

...
class TC_VNFC_SCALE_OUT_003__VNF_ONDEMAND(TestCase):
    """
    TC_VNFC_SCALE_OUT_003__VNF_ONDEMAND Scale-in VNFC instance with on-demand scaling event generated by VNF
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_003__VNF_ONDEMAND')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_003__VNF_ONDEMAND')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_003__VNF_ONDEMAND')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_003__VNF_ONDEMAND execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_003__VNF_ONDEMAND execution completed successfully')

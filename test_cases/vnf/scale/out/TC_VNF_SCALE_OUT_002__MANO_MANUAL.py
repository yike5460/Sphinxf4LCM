...
class TC_VNF_SCALE_OUT_002__MANO_MANUAL(TestCase):
    ...
    def setup(self):
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_002__MANO_MANUAL')

        return True

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_002__MANO_MANUAL')
        ...
        if self.ns_instance_id is None:
            LOG.error('TC_VNF_SCALE_OUT_002__MANO_MANUAL execution failed')
        ...
        LOG.info('TC_VNF_SCALE_OUT_002__MANO_MANUAL execution completed successfully')

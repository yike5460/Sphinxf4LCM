...
class TC_VNFC_SCALE_OUT_002_6(TestCase):
    """
    TC_VNFC_SCALE_OUT_002_6 Max scale-out VNFC instance with manual scaling event generated by VNF
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_002_6')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_002_6')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_002_6')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_002_6 execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_002_6 execution completed successfully')

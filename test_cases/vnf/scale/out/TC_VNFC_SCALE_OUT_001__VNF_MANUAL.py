...
class TC_VNFC_SCALE_OUT_001__VNF_MANUAL(TestCase):
    """
    TC_VNFC_SCALE_OUT_001__VNF_MANUAL Scale-out VNFC instance with manual scaling event generated by VNF
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_001__VNF_MANUAL')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_001__VNF_MANUAL')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_001__VNF_MANUAL')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_001__VNF_MANUAL execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_001__VNF_MANUAL execution completed successfully')

...
class TC_VNFC_SCALE_OUT_003_7(TestCase):
    """
    TC_VNFC_SCALE_OUT_003_7 Scale-in VNFC instance with manual scaling event generated by EM
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_003_7')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_003_7')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_003_7')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_003_7 execution completed successfully')

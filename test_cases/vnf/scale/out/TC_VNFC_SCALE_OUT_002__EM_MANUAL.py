...
class TC_VNFC_SCALE_OUT_002__EM_MANUAL(TestCase):
    """
    TC_VNFC_SCALE_OUT_002__EM_MANUAL Max scale-out VNFC instance with manual scaling event generated by EM
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_002__EM_MANUAL')

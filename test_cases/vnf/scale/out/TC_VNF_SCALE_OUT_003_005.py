...
class TC_VNF_SCALE_OUT_003_005(TestCase):
    """
    TC_VNF_SCALE_OUT_003_005 Scale-in VNF instance
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_003_005')
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_003_005')

        return True

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_003_005')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNF_SCALE_OUT_003_005 execution failed')
        ...
        LOG.info('TC_VNF_SCALE_OUT_003_005 execution completed successfully')

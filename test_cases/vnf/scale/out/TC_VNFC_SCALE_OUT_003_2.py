...
class TC_VNFC_SCALE_OUT_003_2(TestCase):
    """
    TC_VNFC_SCALE_OUT_003_2 Scale-in VNFC instance with on-demand scaling event generated by VNF
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_003_2')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_003_2')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_003_2')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_003_2 execution failed')
        ...
        # 5. Trigger a resize of the VNF resources to the next level by increasing the traffic load to the maximum
        # --------------------------------------------------------------------------------------------------------------
        LOG.info('Triggering a resize of the VNF resources to the next level by increasing the traffic load to the maximum')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_003_2 execution completed successfully')

...
class TC_VNF_SCALE_OUT_002_5(TestCase):
    """
    TC_VNF_SCALE_OUT_002_5 Max scale-out VNF instance with manual scaling event generated by MANO
    ...
    def setup(self):
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_002_5')

        return True

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_002_5')
        ...
        scale_ns_data.scale_ns_by_steps_data.number_of_steps = self.tc_input['scaling']['max_instances']
        ...
        LOG.info('TC_VNF_SCALE_OUT_002_5 execution completed successfully')

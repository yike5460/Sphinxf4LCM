...
class TC_VNF_SCALE_OUT_003_5(TestCase):
    """
    TC_VNF_SCALE_OUT_003_5 Scale-in VNF instance with manual scaling event generated by MANO
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_003_5')
    ...
    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_003_5')
        ...
        if self.ns_instance_id is None:
            LOG.error('TC_VNF_SCALE_OUT_003_5 execution failed')
        ...
        if not self.traffic.any_traffic_loss():
            LOG.error('TC_VNF_SCALE_OUT_003_5 execution failed')
            LOG.debug('Normal traffic flew without packet loss')
            self.tc_result['overall_status'] = constants.TEST_FAILED
            self.tc_result['error_info'] = 'Normal traffic flew without packet loss'
            return False
        ...
        LOG.info('TC_VNF_SCALE_OUT_003_5 execution completed successfully')

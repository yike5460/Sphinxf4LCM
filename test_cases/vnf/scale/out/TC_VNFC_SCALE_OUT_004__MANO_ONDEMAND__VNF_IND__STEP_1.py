...
class TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VNF_IND__STEP_1(TestCase):
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VNF_IND__STEP_1')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VNF_IND__STEP_1')

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VNF_IND__STEP_1')
        ...
        for scale_out_level in range(self.tc_input['desired_scale_out_steps'] + 1):
            ...
            if notification_info is None:
                LOG.error('TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VNF_IND__STEP_1 execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VNF_IND__STEP_1 execution completed successfully')

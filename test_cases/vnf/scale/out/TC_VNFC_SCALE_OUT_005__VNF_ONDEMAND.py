...
class TC_VNFC_SCALE_OUT_005__VNF_ONDEMAND(TestCase):
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_005__VNF_ONDEMAND')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_005__VNF_ONDEMAND')

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_005__VNF_ONDEMAND')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_005__VNF_ONDEMAND execution completed successfully')

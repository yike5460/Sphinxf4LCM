...
class TC_VNFC_SCALE_OUT_004__EM_ONDEMAND__STEP_1(TestCase):
    """
    TC_VNFC_SCALE_OUT_004__EM_ONDEMAND__STEP_1 Max vResource VNFC limit reached before max VNFD limit for
    scale-out with on-demand scaling event generated by the EM.
    ...
    def run(self):
        ...
        for scale_out_level in range(self.tc_input['desired_scale_out_steps'] + 1):
            ...
            if notification_info is None:
                LOG.error('TC_VNFC_SCALE_OUT_004__EM_ONDEMAND__STEP_1 execution failed')

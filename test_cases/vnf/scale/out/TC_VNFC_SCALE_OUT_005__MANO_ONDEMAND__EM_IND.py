...
class TC_VNFC_SCALE_OUT_005__MANO_ONDEMAND__VNF_IND(TestCase):
    """
    TC_VNFC_SCALE_OUT_005__MANO_ONDEMAND__VNF_IND Removal of virtualized specialized hardware acceleration for VNFC
    ...
    def setup(self):
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_005__MANO_ONDEMAND__VNF_IND')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_005__MANO_ONDEMAND__VNF_IND')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_005__MANO_ONDEMAND__VNF_IND execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_005__MANO_ONDEMAND__VNF_IND execution completed successfully')

...
class TC_VNFC_SCALE_OUT_003_1(TestCase):
    """
    TC_VNFC_SCALE_OUT_003_1 Scale-in VNFC instance with on-demand scaling event generated by MANO
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_003_1')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_003_1')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_003_1')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_003_1 execution failed')
        ...
        # --------------------------------------------------------------------------------------------------------------
        LOG.info(
            'Triggering a resize of the VNF resources to the next level by increasing the traffic load to the maximum')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_003_1 execution completed successfully')

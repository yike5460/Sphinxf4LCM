...
class TC_VNFC_SCALE_OUT_005_1(TestCase):
    """
    TC_VNFC_SCALE_OUT_005_1 Removal of virtualized specialized hardware acceleration for VNFC scale-in with on-demand 
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_005_1')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_005_1')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_005_1')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_005_1 execution completed successfully')

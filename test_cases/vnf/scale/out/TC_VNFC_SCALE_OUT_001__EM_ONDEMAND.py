...
class TC_VNFC_SCALE_OUT_001__EM_ONDEMAND(TestCase):
    """
    TC_VNFC_SCALE_OUT_001__EM_ONDEMAND Scale-out VNFC instance with on-demand scaling event generated by EM
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_001__EM_ONDEMAND')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_001__EM_ONDEMAND')

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_001__EM_ONDEMAND')
        ...
        while elapsed_time < constants.SCALE_INTERVAL:
            ...
            if elapsed_time == constants.SCALE_INTERVAL:
                LOG.error('TC_VNFC_SCALE_OUT_001__EM_ONDEMAND execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_001__EM_ONDEMAND execution completed successfully')

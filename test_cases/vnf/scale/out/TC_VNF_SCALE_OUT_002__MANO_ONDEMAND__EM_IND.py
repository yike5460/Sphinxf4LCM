...
class TC_VNF_SCALE_OUT_002__MANO_ONDEMAND__EM_IND(TestCase):
    """
    TC_VNF_SCALE_OUT_002__MANO_ONDEMAND__EM_IND Max scale-out VNF instance with on-demand scaling event generated by
    MANO. The stimulus for scaling out consists of value changes of one or multiple VNF related indicators on the
    interface produced by the EM.
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_SCALE_OUT_002__MANO_ONDEMAND__EM_IND')
        ...
        LOG.info('Finished setup for TC_VNF_SCALE_OUT_002__MANO_ONDEMAND__EM_IND')

    def run(self):
        LOG.info('Starting TC_VNF_SCALE_OUT_002__MANO_ONDEMAND__EM_IND')
        ...
        while elapsed_time < constants.SCALE_INTERVAL:
            ...
            if elapsed_time == constants.SCALE_INTERVAL:
                LOG.error('TC_VNF_SCALE_OUT_002__MANO_ONDEMAND__EM_IND execution failed')
        ...
        LOG.info('TC_VNF_SCALE_OUT_002__MANO_ONDEMAND__EM_IND execution completed successfully')

...
class TC_VNFC_SCALE_OUT_002_2(TestCase):
    """
    TC_VNFC_SCALE_OUT_002_2 Max scale-out VNFC instance with on-demand scaling event generated by VNF
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_002_2')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_002_2')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_002_2')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_002_2 execution failed')
        ...
        LOG.info('TC_VNFC_SCALE_OUT_002_2 execution completed successfully')

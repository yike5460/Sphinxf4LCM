...
class TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_MAX(TestCase):
    """
    TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_MAX Max vResource VNFC limit reached before max VNFD limit for
    scale-out with on-demand scaling event generated by MANO and triggered by a VIM key performance indicator value
    change. Scaling step is set to max_instances.
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_MAX')
        ...
        LOG.info('Finished setup for TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_MAX')

        return True

    def run(self):
        LOG.info('Starting TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_MAX')
        ...
        if reservation_id is None:
            LOG.error('TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_MAX execution failed')
        ...
        if notification_info is None:
            LOG.error('TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_MAX execution failed')
            LOG.debug('Could not validate that scaling out has been attempted')
            self.tc_result['overall_status'] = constants.TEST_FAILED
        ...
        LOG.info('TC_VNFC_SCALE_OUT_004__MANO_ONDEMAND__VIM_KPI__STEP_MAX execution completed successfully')

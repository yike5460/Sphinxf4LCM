...
class TC_VNF_STATE_INST_006(TestCase):
    ...
    7. Terminate the VNF
    8. Validate that the VNF is terminated and that all resources have been released by the VIM
    """
    ...
    def run(self):
        ...
        # --------------------------------------------------------------------------------------------------------------
        # 8. Validate that the VNF is terminated and all resources have been released by the VIM
        # --------------------------------------------------------------------------------------------------------------

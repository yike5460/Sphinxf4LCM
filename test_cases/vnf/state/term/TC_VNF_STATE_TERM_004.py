...
class TC_VNF_STATE_TERM_004(TestCase):
    """
    TC_VNF_STATE_TERM_004 VNF terminate from state STOPPED without load
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_STATE_TERM_004')
        ...
        LOG.info('Finished setup for TC_VNF_STATE_TERM_004')

        return True

    def run(self):
        LOG.info('Starting TC_VNF_STATE_TERM_004')
        ...
        if self.vnf_instance_id is None:
            LOG.error('TC_VNF_STATE_TERM_004 execution failed')
        ...
        LOG.info('TC_VNF_STATE_TERM_004 execution completed successfully')

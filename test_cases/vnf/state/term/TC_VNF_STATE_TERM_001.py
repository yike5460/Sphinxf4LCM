...
class TC_VNF_STATE_TERM_001(TestCase):
    """
    TC_VNF_STATE_TERM_001 VNF terminate from state STARTED without traffic load
    ...
    def step2(self):
        ...
        self.vnf_info = self.mano.vnf_query(query_filter={'vnf_instance_id': self.vnf_instance_id,

...
class TC_VNF_STATE_START_demo(TestCase):
    """
    TC_VNF_STATE_START_demo VNF Start under low traffic load and measure start time
    ...
    def setup(self):
        LOG.info('Starting setup for TC_VNF_STATE_START_demo')
        ...
        LOG.info('Finished setup for TC_VNF_STATE_START_demo')

    def run(self):
        LOG.info('Starting TC_VNF_STATE_START_demo')
        ...
        LOG.info('TC_VNF_STATE_START_demo execution completed successfully')

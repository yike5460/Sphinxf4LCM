...
class TD_NFV_NSLCM_INSTANTIATE_001(TestCase):
    ...
    def run(self):
        ...
        # verify_allocated_vresources VNF case
        vresources = {'vnfc1_id': {'vCPU': {'expected': 'expected_number_vcpus',
                                            'actual': 'actual_number_vcpus',
                                            'validation_result': 'successful'},
                                   'vMemory': {'expected': 'expected_vmemory_size',
                                               'actual': 'actual_vmemory_size',
                                               'validation_result': 'successful'},
                                   'vStorage': {'expected': 'expected_vstorage_size',
                                                'actual': 'actual_vstorage_size',
                                                'validation_result': 'successful'},
                                   'vNIC': {'expected': 'expected_number_vncics',
                                            'actual': 'actual_number_vnics',
                                            'validation_result': 'successful'}},
                      'vnfc2_id': {'vCPU': {'expected': 'expected_number_vcpus',
                                            'actual': 'actual_number_vcpus',
                                            'validation_result': 'successful'},
                                   'vMemory': {'expected': 'expected_number_vcpus',
                                               'actual': 'actual_number_vcpus',
                                               'validation_result': 'successful'},
                                   'vStorage': {'expected': 'expected_number_vcpus',
                                                'actual': 'actual_number_vcpus',
                                                'validation_result': 'successful'},
                                   'vNIC': {'expected': 'expected_number_vcpus',
                                            'actual': 'actual_number_vcpus',
                                            'validation_result': 'successful'}}}

        # get_allocated_vresources NS case
        self.tc_result['resources']['Initial'] = {'vnf_instance1_id': {'vnfc1_id': {'vCPU': 'number_vcpus',
                                                                                    'vMemory': 'vmemrory_size',
                                                                                    'vStorage': 'vstorage_size',
                                                                                    'vNIC': 'number_vnics'},
                                                                       'vnfc2_id': {'vCPU': 'number_vcpus',
                                                                                    'vMemory': 'vmemrory_size',
                                                                                    'vStorage': 'vstorage_size',
                                                                                    'vNIC': 'number_vnics'}},
                                                  'vnf_instance2_id': {'vnfc1_id': {'vCPU': 'number_vcpus',
                                                                                    'vMemory': 'vmemrory_size',
                                                                                    'vStorage': 'vstorage_size',
                                                                                    'vNIC': 'number_vnics'},
                                                                       'vnfc2_id': {'vCPU': 'number_vcpus',
